...
final class AntShortestPathTest {
    ...
    /**
     * Вершина b — тупик длиной в одно ребро, а единственный путь до d состоит из двух.
     * Муравей, застрявший в тупике, имеет непустой путь и меньшую длину, поэтому без проверки
     * прибытия в цель именно он и объявляется «кратчайшим путём». Веса рёбер равны, иначе
     * эвристика 1/вес уводит почти всех муравьёв в дешёвый тупик и тест становится плавающим.
     */
    private static List<Graph.Vertex<String, Integer>> path() {
        Graph<String, Integer> graph = graph("{a,b,1}{a,c,1}{c,d,1}");
